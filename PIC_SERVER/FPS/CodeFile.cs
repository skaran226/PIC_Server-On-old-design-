        ...
        static string[] GetEodStartTime()
        {
            ...
            try
            {
                ...
                if(drRecordSet.HasRows)
                {
                    ...
                    //sShowTimeStar = drRecordSet["SHOW_TIME_END"].ToString();
...
public class SQL_SERVER
{
    ...
    public static void Set_Sql_Server_Conn()
    {
        ...
        string server_string = "Data Source=LAPTOP-EMJVR3G8;Initial Catalog=master;Integrated Security=True;MultipleActiveResultSets=true";
